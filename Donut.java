...
public class Donut implements ActionListener, KeyListener{

     private final int LENGTH = 12, HEIGHT = 10;
    ...
    */
    ...
    Donut() {
        ...
        grid.setBounds(100, 100, 600, 500);
    ...
    public void checkGameOver() {
        if(player1Score + player2Score != 96) return;
